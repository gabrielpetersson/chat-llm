...
const ChatConfigDumb: FC<ChatConfigDumbProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "flex cursor-auto flex-col rounded bg-white p-4",
          agentConfig != null ? "w-[1000px]" : "w-[500px]"
        )}
      >
        <Section>
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <button
                className="h-6 rounded border border-gray-400 px-2 hover:bg-[#fafafa] active:bg-[#f4f4f4]"
                onClick={toggleAgent}
              >
                Agents
              </button>
        ...
        <div className="flex">
          ...
          {agentConfig != null ? (
            <div className="flex flex-1">Here are agents!</div>
          ) : null}
        </div>
      </div>
    </div>
